  ...
  return (
    ...
    >
      <div className="modal-content p-6 text-center">
        <div className="w-14 h-14 mx-auto mb-4 bg-indigo-50 rounded-xl flex items-center justify-center">
        ...
        <div className="bg-slate-50 rounded-xl p-4 mb-5 text-sm">
          ...
          <p className="text-slate-600 mt-1">
            🧾 Jami cheklar: <span className="font-semibold text-indigo-600">{user.checkCount}</span>
          </p>
        </div>
